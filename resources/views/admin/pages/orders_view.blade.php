...
<head>
    ...
    <title>INFODI | View Orders</title>
                ...
                <div class="layout-px-spacing">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="javascript:void(0);">View Order</a></li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row layout-spacing">
                            ...
                            <div class="user-profile layout-spacing">
                                <div class="widget-content widget-content-area">
                                    <div class="d-flex justify-content-between">
                                        <h3 class="javascript:void(0);">Customer Info</h3>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                            <div class="skills layout-spacing ">
                                <div class="widget-content widget-content-area">
                                    <h3 class="">Edit Order Tracking</h3>
                                    <form>
                                        <div class="form-group mb-4">
                                            <label for="inputPassword4">Delivary Agent Name</label>
                                            <input type="text" class="form-control" id="inputPassword4"
                                                placeholder="Agent Name">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="inputPassword4">Delivary Agent Number</label>
                                            <input type="text" class="form-control" id="inputPassword4"
                                                placeholder="Agent Number">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="inputPassword4">Delivary Status</label>
                                            <select id="inputState" class="form-control">
                                                <option selected>Select Delivary Status</option>
                                                <option>Delivered</option>
                                            </select>
                                        </div>
