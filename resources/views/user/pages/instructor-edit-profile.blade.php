                            ...
                            <div class="profile-bg">
                                ...
                                <div class="profile-img">
                                    <a href="{{ url('/user-profile') }}"><img
                                            src="{{ asset('user/assets/img/user/user15.jpg') }}" alt=""></a>
                                </div>
                            </div>
                                        ...
                                        <a href="{{ url('/user-profile') }}">
                                            ...
                                            {{-- <input type="file" name="image" class="form-control"><br> --}}
                                                <img name="image"
                                                    ...
                                                    alt="" class="img-fluid">
                                            @elseif($data->userImage)
                                            
                                                <img src="{{ asset('user/assets/img/user/'.$data->userImage) }}" width="300"
                                                height="338"/>
                                            @endif
                                        </a>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    value="{{ $data->name }}" placeholder="Enter your first Name">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone"
                                                    value="{{ $data->mobile }}" placeholder="Enter your Phone">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="state"
                                                    value="{{ $data->state }}" placeholder="Address">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="zip"
                                                    value="{{ $data->zip }}" placeholder="Enter your Zipcode">
                                            </div>
                                        </div>
