                            ...
                            <div class="course-group mb-0 d-flex">
                                <div class="course-group-img d-flex align-items-center">
                                    <a href="{{ url('/user-profile') }}">
                                        ...
                                        <img src="data:image/jpg;charset=utf8;base64,{{base64_encode($data->image)}}"/> --}}
                                        @endif
                                    </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="{{ $data->mobile }}"
                                        ...
                                        {{-- <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="dob" value="{{ $data->name }}"
