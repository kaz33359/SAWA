    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{ url('admin/login') }}"><img alt="logo" src="{{ asset('admin/assets/img/.png') }}">INFODI</a>
            </div>
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a
                                    href="javascript:void(0);">Enquiries</a></li>
                        </ol>
                    </nav>
                </div>
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                <li><a href="{{ url('admin/enquiry_view') }}" class="bs-tooltip"
                                                        ...
                                                        data-original-title="View Message"><i data-feather="eye"></i>
                                                    </a>
                                                </li>
                                                <li><a href="{{ url('admin/enquiry/delete/') }}/{{ $enquiry->id }}" class="bs-tooltip"
                                                        data-toggle="tooltip" data-placement="top" title=""
