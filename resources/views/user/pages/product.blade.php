                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    <div class="view-icons">
                                        <a href="{{ url('/course-grid') }}" class="grid-view"><i
                                                class="feather-grid"></i></a>
                                        <a href="{{ url('/product') }}" class="list-view active"><i
                                ...
                                <div class="course-box course-design list-course d-flex">
                                    <div class="product">
                                        <div class="product-img">
                                            ...
                                            <a href="{{ url('/course-details') }}/{{ $single_product->id }}">
                                                <img class="img-fluid" alt=""
                                                    src="{{ asset('product_image') }}/{{ $single_product->product_image }}">
                                            </a>
                                            <div class="price">
                                        ...
                                        $category = DB::table('categories')
                                            ->where('id', '=', $single_product->product_category)
                                            ->first();
                                        ...
                                        <div class="product-content">
                                            <div class="head-course-title">
                                                <h3 class="title"><a
                                                        href="{{ url('/course-details') }}/{{ $single_product->id }}">{{ $single_product->product_name }}</a>
                                                </h3>
                                            ...
                                            <div class="course-info border-bottom-0 pb-0 d-flex align-items-center">
                                                <div class="rating-img d-flex align-items-center">
                                                    <img src="{{ asset('user/assets/img/icon/icon-01.svg') }}"
                                                        alt="">
